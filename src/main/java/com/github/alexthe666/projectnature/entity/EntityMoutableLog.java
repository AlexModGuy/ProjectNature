 ...
 * @author #2- Alex :P
 */
public class EntityMoutableLog extends Entity
{
	public BlockPos blockPos;
	public Block block;

	public EntityMoutableLog(World world)
	{
		super(world);
	}

	public EntityMoutableLog(World world, BlockPos pos, float mountX, float mountY, float mountZ)
	{
		super(world);
		noClip = true;
	...
	public void onEntityUpdate()
	{
		if (!worldObj.isRemote) {
			...
			else if (worldObj.getBlockState(blockPos).getBlock() != null){
